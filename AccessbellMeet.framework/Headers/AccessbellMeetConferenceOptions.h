...
#import "AccessbellMeetUserInfo.h"


@interface AccessbellMeetConferenceOptionsBuilder : NSObject
 ...
 * https://github.com/accessbell/accessbell-meet/blob/master/react/features/base/color-scheme/defaultScheme.js
 */
@property (nonatomic, copy, nullable) NSDictionary *colorScheme;

/**
 * Feature flags. See: https://github.com/accessbell/accessbell-meet/blob/master/react/features/base/flags/constants.js
 */
 ...
 */
@property (nonatomic, nullable) AccessbellMeetUserInfo *userInfo;
...
@interface AccessbellMeetConferenceOptions : NSObject
...
+ (instancetype _Nonnull)fromBuilder:(void (^_Nonnull)(AccessbellMeetConferenceOptionsBuilder *_Nonnull))initBlock;
